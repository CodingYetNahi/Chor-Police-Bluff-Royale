  ...
  credits: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'All sound effects and harmonic tones are procedurally generated in real time using the standard Web Audio API synthesis oscillator system. No copyrighted audio tracks or third-party audio files are utilized.'
      },
      {
